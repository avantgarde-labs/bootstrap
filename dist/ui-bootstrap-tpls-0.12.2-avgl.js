...
angular.module("template/typeahead/typeahead-heading.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/typeahead/typeahead-heading.html",
    "<h4 tabindex=\"-1\" role=\"heading\" class=\"typeahead-heading\">{{ heading }}</h4>\n" +
    "");
}]);
...
angular.module("template/typeahead/typeahead-popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/typeahead/typeahead-popup.html",
    ...
    "        <div ng-if=\"hasHeading($index)\" typeahead-heading template-url=\"headingTemplateUrl\" heading=\"getHeading($index)\"></div>\n" +
    "        <div typeahead-match index=\"$index\" match=\"match\" query=\"query\" template-url=\"templateUrl\" active=\"isActive($index)\"></div>\n" +
    "    </li>\n" +
    "</ul>\n" +
    "");
}]);
